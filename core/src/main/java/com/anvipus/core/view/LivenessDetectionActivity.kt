...
import com.anvipus.core.base.BaseCameraActivity
import com.anvipus.core.utils.MemoryUsageMonitor
import com.anvipus.core.utils.analyzer.DetectionMode
import com.anvipus.core.utils.analyzer.LivenessDetectionListener
...
import com.anvipus.core.utils.analyzer.FaceStatus
import com.anvipus.core.utils.analyzer.LivenessDetectionAnalyzer
...
class LivenessDetectionActivity : BaseCameraActivity(), LivenessDetectionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        memoryUsageMonitor = MemoryUsageMonitor(this, getSystemService(ACTIVITY_SERVICE) as ActivityManager, lowMemoryThreshold = Identifier.lowMemoryThreshold)
        ...
        val analysisUseCase = ImageAnalysis.Builder().build().also {
            it.setAnalyzer(cameraExecutor,
                LivenessDetectionAnalyzer(
                    ...
                    Rect(
                        ivFace.left - offset * 2,
                        ivFace.top - offset,
                        ivFace.right + offset * 2,
                        ivFace.bottom + offset
                    ),
                    graphicOverlay,
                    false,
                    this
