...
import com.anvipus.core.utils.analyzer.FaceDetectionAnalyzer
import com.anvipus.core.utils.analyzer.FaceDetectionListener
...
import com.anvipus.core.utils.Identifier.lowMemoryThreshold
...
class SelfieWithKtpActivity : BaseCameraActivity(), FaceDetectionListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        memoryUsageMonitor = MemoryUsageMonitor(this, getSystemService(ACTIVITY_SERVICE) as ActivityManager, lowMemoryThreshold = lowMemoryThreshold)
    }
